...
const jeffTexture = new THREE.TextureLoader().load('myPic.png');

const jeff = new THREE.Mesh(new THREE.CircleBufferGeometry(2, 20), new THREE.MeshBasicMaterial({ map: jeffTexture }));
